...
def main():
    ...
    fixed_range = [p1.obs_range[obs] for obs in sorted(p1.observs_tostudy)] #Sort bc in alphab order later

    hist_total = processing.make_histograms(data=proc_data, params=params_nomarg,
            fixed_bins=p1.fixed_bins, normed=False,
