...
!            dlnk0=2._dl/10/AccuracyBoost
            dlnk0=2._dl/10/AccuracyBoost/kSrcSampleBoost
!END MODIFIED P(K)
...
!            dlnk0=5._dl/10/AccuracyBoost
            dlnk0=5._dl/10/AccuracyBoost/kSrcSampleBoost
!END MODIFIED P(K)
...
!         dkn2=1.1_dl/taurst/AccuracyBoost 
         dkn1=0.6_dl/taurst/AccuracyBoost/kSrcSampleBoost
         dkn2=1.1_dl/taurst/AccuracyBoost/kSrcSampleBoost
!END MODIFIED P(K)
...
!       IntSampleBoost=AccuracyBoost
       IntSampleBoost=AccuracyBoost/kIntSampleBoost
!END MODIFIED P(K)
